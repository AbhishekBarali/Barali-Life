...
// Variety pools - pick random items from these for variety
// ============================================
const BREAKFAST_PROTEINS = ['EGGS_BOILED', 'EGGS_OMELETTE', 'EGGS_FRIED', 'EGGS_BHURJI', 'CHANA_EGG', 'CHANA_EGG_FRY'];
const BREAKFAST_CARBS = ['BREAD_PEANUT_BUTTER', 'PARATHA', 'OATS', 'BREAD_HONEY', 'MUESLI', 'CORNFLAKES'];
...
const SNACK_PROTEINS = ['WHEY', 'PEANUTS', 'ALMONDS', 'ROASTED_CHANA', 'MIXED_NUTS', 'EGGS_BOILED', 'CHANA_BOILED', 'KALA_CHANA', 'CHANA_CHAAT'];
